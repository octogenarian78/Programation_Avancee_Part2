...
public class MasterSocket {
	...
	// MC parameters
	long totalCount = 72072000; // total number of throws on a Worker
...
//	}
     ...
     WriteToFile.write(totalCount,numWorkers,(stopTime - startTime),pi,(Math.abs((pi - Math.PI))),"Socket_forte");
